        ...
        executor.submit(() -> {
            ...
            try (ObjectInputStream clientReader = new ObjectInputStream(socket.getInputStream());
                ...
                do {
                    ...
                    ThreadClass threadClass = new ThreadClass(responseToUser, userRequest, requestHandler, clientWriter);
                    ForkJoinPool.commonPool().execute(threadClass);
        ...
        while (true) {
            ...
            switch (command) {
                ...
                case "exit" -> {
                    ...
                    System.out.println("Давай, проваливай!");
                    System.exit(0);
                }
                default -> {
